...
use Obvu\Modules\Api\AdminSubmodules\Crud\helpers\BaseInitialization;
...
{
    public $crudSettings = [];
    const EVENT_SAVE_ELEMENT = 'EVENT_SAVE_ELEMENT';

    /**
     * @var BaseInitialization
     */
    public $initilizationClassName = null;
    ...
    {
        return $this->getIniter()->getHandler($type);
    }
